...
public class ReceiptServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SUPABASE_URL: " + dotenv.get("SUPABASE_URL"));
        System.out.println("SUPABASE_BUCKET_NAME: " + dotenv.get("SUPABASE_BUCKET_NAME"));
        System.out.println("SUPABASE_SERVICE_ROLE_KEY: " + dotenv.get("SUPABASE_SERVICE_ROLE_KEY"));
